  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-50 text-green-800 font-mono p-4">
      <div className="max-w-md w-full bg-emerald-50/45 border-2 border-emerald-300 rounded-lg p-6 md:p-8 flex flex-col gap-6 relative shadow-[0_0_40px_rgba(16,185,129,0.06)]">
        ...
        <div className="flex justify-between border-b border-emerald-250 pb-2 mb-2 text-[10px] uppercase tracking-widest text-emerald-950 font-bold select-none">
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-emerald-900 uppercase font-semibold">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="nome" className="block text-xs uppercase tracking-widest text-emerald-955 font-bold">
              [ NOME_DO_ALUNO ]
            </label>
            <input
              type="text"
              ...
              required
              disabled={loading}
              className="w-full bg-white border-2 border-emerald-300 p-4 text-center text-xl font-mono font-bold text-emerald-800 focus:outline-none focus:border-emerald-600 transition-all uppercase placeholder-emerald-300"
              autoFocus
            />
          </div>

          {error && (
            <div className="bg-red-50 text-red-650 p-3 rounded border border-red-300 text-xs font-mono font-bold uppercase tracking-wider">
        ...
        <div className="mt-4 pt-4 border-t border-emerald-200 text-center">
          <p className="text-[9px] text-emerald-950 uppercase tracking-widest font-bold select-none">
